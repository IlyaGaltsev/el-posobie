        ...
        <section id="0">
          ...
          <p className="c1">
            <span className="c0">
              ...
              68% [1]. Это высокотехнологичная техника, порой основанная на новых принципах, введены
          ...
          <p className="c1">
            <span className="c0">
              ...
              необходимых знаний и навыков, а также психологическая подготовка допризывной молодежи
        ...
        <section id="1">
          ...
          <p className="c1">
            ...
            <span className="c0">
              ...
              граждан Российской Федерации к военной службе» от 31 декабря 1999 г. N 1441 [6].
            </span>
          </p>
          <p className="c1">
            <span className="c2">
            ...
            <span className="c0">
              ...
              пунктах» от 24 февраля 2010 г. № 96/134 [7]. Данный документ содержит задачи, функции
              органов военного управления и органов управления образования, порядок организации
              обучения граждан Российской Федерации начальным знаниям в сфере обороны.
            </span>
          </p>
          <p className="c1">
          ...
          <p className="c1">
            ...
            <span className="c0">
              ...
              подготовки граждан по военно-учетным специальностям [9].
            </span>
          </p>
          <p className="c1">
            <span className="c2">
            ...
            <span className="c0">
              ...
              экспертизе, а также перечень военно-учетных специальностей [9].
            </span>
          </p>
          <p className="c1">
            <span className="c2">
          ...
          <p className="c1">
            <span className="c0">
              ...
              проведении сборов в учебных заведениях, в других организациях - силами и средствами,
              определенными решением главы органа местного самоуправления [12].
            </span>
          </p>
          <p className="c1">
            <span className="c0">
          ...
          <p className="c1">
            <span className="c0">
              ...
              структур» № 2240-II Государственной Думы [14]. В нем говорилось, что Вооруженные Силы
          ...
          <p className="c1">
            ...
            <span className="c0">
              &nbsp;Отличительной особенностью организации военно-патриотической работы в
              Вооруженных Силах Российской Федерации является проведение в соответствии со статьей 5
              Федерального закона "О днях воинской славы (Днях Победы)" От 13 марта 1995 г. № 32-ФЗ
              воинских ритуалов, торжеств и праздничных салютов в последующие дни [15]:
            </span>
          </p>
          <p className="c1">
            <span className="c0">
          ...
          <p className="c1">
            <span className="c0">
              ...
              порядок подготовки и проведения торжественных мероприятий определяются в соответствии
              с законодательством Российской Федерации и уставами Вооруженных Сил Российской
              Федерации" [16,20].
            </span>
          </p>
          <p className="c1 c15">
    ...
    content: () => {
      return (
        <section id="2">
          <p className="c1">
            <span className="c21 c2 c19">
              Глава 2. Требования постановления Правительства РФ от 31 декабря 1999г. №&nbsp;1441
              «Об утверждении Положения «О подготовке граждан Российской Федерации к военной
              службе».
            </span>
          </p>
          <a id="id.1t3h5sf" />
        ...
        <section id="7">
          ...
          <p className="c1">
            <span className="c0">
              ...
              обучаемых навыков правильного выполнения требований уставов на практике [20].
            </span>
          </p>
          <p className="c1">
            <span className="c0">
        ...
        <section id="9">
          ...
          <p className="c1">
            <span className="c0">
              ...
              учебный вопрос. Есть возможность проверить знание обучающихся теоретических положений
              по теме предстоящего занятия.
            </span>
          </p>
          <p className="c1">
            <span className="c0">
        ...
        <section id="10">
          ...
          <p className="c1">
            <span className="c0">
              ...
              предстоящего урока. Он доводит до обучаемых требования мер безопасности при обращении
              с оружием, средствами индивидуальной защиты и имитационными средствами, используемыми
              на занятиях, указывает порядок безопасного выполнения элементов урока.
            </span>
          </p>
          <p className="c1">
            <span className="c0">
    ...
    content: (navigate: any) => {
      return (
        <section id="16">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[13].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[14].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
    ...
    content: (navigate: any) => {
      return (
        <section id="18">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[2].id}`)}>Вариант презентации к занятию</a>{' '}
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[3].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[4].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[6].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              {' '}
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[7].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[8].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[9].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
    ...
    content: (navigate: any) => {
      return (
        <section id="20">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[10].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[11].id}`)}>Вариант презентации к занятию</a>{' '}
            </span>
          </p>
          <p className="c12">
            <span className="c2">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[12].id}`)}>Вариант презентации к занятию</a>{' '}
            </span>
          </p>
          <p className="c12">
            <span className="c2">
    ...
    content: (navigate: any) => {
      return (
        <section id="22">
          ...
          <p className="c12">
            <span className="c2">
              <a onClick={() => navigate(`${PREZENTATIONS_ROUTE}/${massPrez[1].id}`)}>Вариант презентации к занятию</a>
            </span>
          </p>
          <p className="c12">
            <span className="c2">
