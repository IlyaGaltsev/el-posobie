...
export const tutorialSection = [
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph>На федеральном уровне запланированы следующие военно-патриотические мероприятия:</Paragraph>
          <ul>
          ...
          <br />
          <Paragraph>На региональном уровне формами военно-патриотической работы являются:</Paragraph>
          <ul>
            <li>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph>35. Продолжительность учебных занятий составляет 5 дней (35 учебных часов)</Paragraph>
          <br />
          <Paragraph>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph>На служебном совещании директор образовательной организации или по его указанию:</Paragraph>
          <ol>
            <li>
          ...
          <br />
          <Paragraph className="under__text">9. Подготовка документации для учебных сборов.</Paragraph>
          <br />
          <Paragraph>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph>В составе колонны 1-2 медицинских работника должны следовать в одном из автобусов.</Paragraph>
          <br />
          <Paragraph>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph>Для ознакомления с приемом классный руководитель (командир) должен: </Paragraph>
          <ul>
          ...
          <br />
          <Paragraph>В зависимости от сложности упражнения его разучивание может осуществляться: </Paragraph>
          <ul>
          ...
          <br />
          <Paragraph>Второй этап последовательно объединяет элементы в группы, а затем в единое целое.</Paragraph>
          <br />
          <Paragraph>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph className="under__text">Методика проведения подготовительной части урока.</Paragraph>
          <br />
          <Paragraph>
          ...
          <br />
          <Paragraph className="under__text">Методика проведения заключительной части урока.</Paragraph>
          <br />
          <Paragraph>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph className="under__text">Особенности отработки нормативов по огневой подготовке.</Paragraph>
          <br />
          <Paragraph>
  ...
  },
  {
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          <Paragraph>8.1. Требования к результатам обучения на учебных сборах по основам военной службы.</Paragraph>
          <br />
          <Paragraph>
          ...
          <br />
          <Paragraph className="under__text">8.2. Оценка учебных сборов по основам военной службы</Paragraph>
          <br />
          ...
          <br />
          <Paragraph>Оценка обучаемых по предмету обучения осущесвляется по следующим критериям:</Paragraph>
          <br />
          <Paragraph>8.2.1. Оценка по РХБЗ, тактической, военно-медицинской и инженерной подготовке.</Paragraph>
          <br />
          <Paragraph>Обучаемые проверяются по выполнению трех-четырех нормативов, и оцениваются:</Paragraph>
          <br />
          <Paragraph>
  ...
  },
  {
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          <Paragraph className="under__text">Тема 1: Строевые приемы и движения без оружия.</Paragraph>
          <br />
          <Paragraph>
  ...
  },
  {
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          <Paragraph className="under__text">Тема 1. Средства индивидуальной защиты и пользование ими.</Paragraph>
          <br />
          <Paragraph>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph className="under__text">Тема 2: Взаимоотношения между военнослужащими.</Paragraph>
          <br />
          <Paragraph>
          ...
          <br />
          <Paragraph>Занятие 2. Групповое – 1 час. Воинские звания и знаки различия военнослужащих.</Paragraph>
          <br />
          <Paragraph>
  ...
  },
  {
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          <Paragraph className="under__text">Тема 1: Первая медицинская помощь при ранениях и переломах.</Paragraph>
          <br />
          <Paragraph>
    ...
    text: () => {
      return (
        <div className="bookpage__text">
          ...
          <br />
          <Paragraph>Занятие 1. Групповое – 1 час. Изучение 2 УНС, мер безопасности при стрельбе.</Paragraph>
          <br />
          <Paragraph>
          ...
          <br />
          <Paragraph className="under__text">Тема 4: Практическая стрельба из пневматической винтовки.</Paragraph>
          <br />
          <Paragraph>
