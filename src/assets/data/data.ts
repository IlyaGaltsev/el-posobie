...
export const tutorialSection: ITutorialSection[] = [
  {
    id: 1,
    timeRead: '5',
    chapter: '',
    title: 'ВВЕДЕНИЕ',
    text: <div className="bookpage__text">
          <Paragraph>
  ...
  },
  {
    id: 2,
    timeRead: '14',
    chapter: 'Раздел I. Основополагающие требования руководящих документов по организации и проведению учебных сборов по основам военной службы с (допризывной молодежью) гражданами Российской Федерации, в рамках подготовки по основам военной службы',
    title: 'Глава 1. Основополагающие требования Федерального закона от 28 марта 1998 г. N 53-ФЗ «О воинской обязанности и военной службе» к обязательной и добровольной подготовке гражданина к военной службе.',
    text: () => {
      return (
  ...
  },
  {
    id: 9,
    timeRead: '9',
    chapter: 'Раздел II. Методика организации и проведения занятий в ходе проведения учебных сборов по основам военной службы',
    title: 'Глава 1. Методические рекомендации по организации и проведению занятий по общевоинским уставам ВС РФ. ',
    text: () => {
      return (
        <div className="bookpage__text">
          <Paragraph>
  ...
  },
  {
    id: 17,
    timeRead: '2',
    chapter: 'Раздел III. Примерная тематика занятий, проводимых в ходе учебных сборов. Планы проведения занятий и презентации к занятиям на учебных сборах по основам военной службы',
    title: 'Глава 1. Примерная тематика занятий и планы проведения занятий  по строевой подготовке.',
    text: () => {
      return (
        <div className="bookpage__text">
          <Paragraph className="under__text">
